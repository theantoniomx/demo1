        ...
        <div class="col-md-12 col-lg-8 mb-5">
            ...
            <div class="row form-group">
              <div class="col-md-12 mb-3 mb-md-0">
                ...
                <input name="name" value="{{old('name')}}" type="text" id="fullname" class="form-control" placeholder="Full Name">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="email">Email</label>
                <input name="email" value="{{old('email')}}" type="email" id="email" class="form-control" placeholder="Email Address">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="email">Subject</label>
                <input name="subject" value="{{old('subject')}}" type="text" id="subject" class="form-control" placeholder="Enter Subject">
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <textarea name="message" value="{{old('message')}}" id="message" cols="30" rows="5" class="form-control" placeholder="Say hello to us"></textarea>
              </div>
            </div>
